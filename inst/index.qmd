...
intro <- tryCatch(
    {
        description <- packageDescription("myNewPackage")
...
👉 [ghcr.io/vjcitn/mynewpackage](https://ghcr.io/vjcitn/mynewpackage) 🐳
...
#| eval: false
docker run -it ghcr.io/vjcitn/mynewpackage:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/vjcitn/mynewpackage:devel
```
...
#| eval: false
docker run -it ghcr.io/vjcitn/mynewpackage:devel bash
